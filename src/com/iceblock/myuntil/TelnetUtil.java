/**
 * 
 * @Title TelnetUtil.java
 * @Package cn.com.starit.nms.otm.web.util
 * @Description Telnet客户端工具
 * @author yan.liang
 * @date 2015年8月10日 下午2:48:42
 * @copyright USTCINFO
 */
...
public class TelnetUtil {
	private TelnetClient telnet = new TelnetClient("VT100");// telnet有VT100 VT52
															// VT220 VTNT
															// ANSI等协议。
	...
	public static void main(String[] args) {
		TelnetUtil telnet = new TelnetUtil("192.168.80.219", "nginx", "nginx123");
